...
| Linux    | —             | Planned (v2)  | LD_PRELOAD / seccomp-bpf | Required: hardware-backed signer such as FIDO2/security key or TPM-backed key | [Tracking issue](https://github.com/stentorian-io/guard/issues/2), [implementation spec](docs/linux-support-v2.md)                                                                                                                                    |
