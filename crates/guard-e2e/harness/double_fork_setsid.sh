...
#   sh (root)               <- stt-guard wrap wraps this
...
# Stentorian Guard's process tree (plan 02-04) records tracked_root at fork time only,
...
# is consumed by the wrapping stt-guard wrap's pipe. The wrapped sh root's
