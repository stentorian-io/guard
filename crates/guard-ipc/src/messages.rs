...
/// Wire-shape mirror of `guard_core::AuditToken`. Defined here (rather than
/// re-using guard-core's) so that wire-vs-domain conversions are explicit
...
impl From<guard_core::AuditToken> for AuditTokenWire {
    fn from(t: guard_core::AuditToken) -> Self {
        Self { val: t.val }
    }
}

impl From<AuditTokenWire> for guard_core::AuditToken {
    fn from(w: AuditTokenWire) -> Self {
        guard_core::AuditToken { val: w.val }
    }
}
...
impl RegisterRoot {
    ...
    pub fn new_for_run(token: guard_core::AuditToken, run_uuid: impl Into<String>) -> Self {
        Self {
            schema_version: IPC_SCHEMA_V1,
            audit_token: AuditTokenWire::from(token),
...
/// Single install artifact recorded by the system installer.
#[derive(Clone, Debug, Serialize, Deserialize, PartialEq, Eq)]
...
// ============================================================
// v0.3 — ReadInstallArtifacts (tag 0x0C; stt-guard uninstall)
// ============================================================
...
// ============================================================
// v0.3 — BaselineCommit (tag 0x0D; stt-guard wrap --baseline exit)
// ============================================================
...
// ============================================================
// v0.7 — ListRules (tag 0x0E; stt-guard status rules)
// ============================================================
...
// ============================================================
// v1.0 — DisableCuratedRule (tag 0x16; stt-guard rules disable)
// ============================================================
...
// ============================================================
// v1.0 — EnableCuratedRule (tag 0x17; stt-guard rules enable)
// ============================================================
