...
fn status_reply_full_ok_round_trip() {
    let r = StatusReply::ok(
        ...
        Some(SigningInfo {
            ...
            signer_kind: Some("software-ml-dsa".into()),
...
fn large_signed_snapshot_publish_frame_exceeds_old_64k_cap() {
    let signature = guard_core::SnapshotSignatureV1 {
        scheme: guard_core::RULE_SIGNATURE_SCHEME_ML_DSA_65_SHA256.into(),
        signer_kind: guard_core::SIGNER_KIND_SOFTWARE_ML_DSA.into(),
