//! crates/sentinel-daemon/src/handlers/disable_curated_rule.rs
//!
//! v1.0 — DisableCuratedRule handler (sentinel rules disable).
//!
//! Validates that the pattern is non-empty and matches at least one
//! curated rule before persisting the override to SQLite.

use sentinel_core::AllowlistEntry;
use sentinel_ipc::{DisableCuratedRule, DisableCuratedRuleReply};
...
mod tests {
    ...
    use sentinel_ipc::DisableCuratedRuleReply;
