//! crates/sentinel-daemon/src/handlers/enable_curated_rule.rs
//!
//! v1.0 — EnableCuratedRule handler (sentinel rules enable).
//!
//! Removes the override row from curated_overrides, re-enabling the
//! curated rule for future snapshots.

use sentinel_ipc::{EnableCuratedRule, EnableCuratedRuleReply};
...
mod tests {
    use super::*;
    use sentinel_ipc::EnableCuratedRuleReply;
