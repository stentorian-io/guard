...
//! remain unaffected by Sentinel even when sentineld is running.

use sentinel_e2e::DaemonHarness;
...
fn ambient_curl_succeeds_with_daemon_running() {
    ...
    // either offline or — critically — Sentinel interfering with non-wrapped
