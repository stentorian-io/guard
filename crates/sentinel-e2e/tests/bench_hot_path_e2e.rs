...
// number) lives in crates/sentinel-hook/benches/cache_hit_hot_path.rs.
//
// Reuses sentinel-e2e::DaemonHarness + resolve_node/cli/dylib per CONTEXT D-34,
...
//   cargo test -p sentinel-e2e --release --test bench_hot_path_e2e -- --ignored --nocapture
