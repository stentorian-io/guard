...
/// returns sentinel_connect. On success it logs "interpose self-test passed".
...
/// SENTINEL_TEST_MARKER to confirm the dylib loaded, then also checks
