...
fn realistic_entries() -> Vec<AllowlistEntry> {
    ...
    vec![
        ...
        allow(RuleTier::CuratedAllow, MatchType::Suffix, ".githubusercontent.com"),
        allow(RuleTier::CuratedAllow, MatchType::Exact, "raw.githubusercontent.com"),
        allow(RuleTier::CuratedAllow, MatchType::Exact, "pypi.org"),
        allow(RuleTier::CuratedAllow, MatchType::Suffix, ".pythonhosted.org"),
    ]
}
