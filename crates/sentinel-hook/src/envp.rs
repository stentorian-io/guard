...
//!
//! Pure-function helper called from `replace_fork.rs::sentinel_posix_spawn`
//! and `sentinel_posix_spawnp` to determine whether to emit an
...
/// required Sentinel env vars is missing. Returns true if envp is null (treat
